...
const TablaGestionUsuarios = () => {
    ...
    return (<main className = "mainContainerTable">
        <ContenedorBotonCentrado>
        <Boton>
        <Link to = "/gestionUsuarios" > Agregar </Link> 
        </Boton> 
        </ContenedorBotonCentrado> 
        <h2 className = "tituloGestionUsuarios" > Gestion de Usuarios </h2> 
